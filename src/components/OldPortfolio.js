...
function OldPortfolio() {
  ...
  return (
    <div className="Portfolio">
      ...
      <h1>gaetaeng.github.io</h1>
      <p>Hi 👋<br />
      저는 꾸준히 공부하며 성장하는 개발자입니다. 새로운 기술을 탐구하고, 다양한 프로젝트를 진행하며 실력을 키워가고 있습니다.</p>
      <p><strong>Contact :</strong> <a href="mailto:nuckly60@gmail.com">nuckly60@gmail.com</a></p>
      <hr />
      <h2>📌 목차 (Projects)</h2>
      <ul>
        <li><a href="#제작중-knights-rest--방치형게임">[제작중] Knights-Rest - 이동</a></li>
        <li><a href="#kordle-helper--꼬들-아나그램">KORDLE Helper - 이동</a></li>
        <li><a href="#제작중-betball--핀볼-내기사이트">[제작중] BetBall - 이동</a></li>
        <li><a href="#제작중-giecl">[제작중] GIECL - 이동</a></li>
        <li><a href="#제작중-회사-포트폴리오">[제작중] [회사] (포트폴리오) - 이동</a></li>
      </ul>
      <hr />
      <h2>[제작중] Knights-Rest / 방치형게임</h2>
      <p><a href="https://gaetaeng.github.io/Knight-s-Rest" rel="nofollow">Knights-Rest 이동</a></p>
      <hr />
      <h2>KORDLE Helper / 꼬들, 아나그램</h2>
      <p><a href="https://gaetaeng.github.io/kordle-helper/" rel="nofollow">KORDLE Helper 이동</a></p>
      <hr />
      <h2>[제작중] BetBall / 핀볼 내기사이트</h2>
      <p><a href="https://gaetaeng.github.io/BetBall/" rel="nofollow">BetBall 이동</a></p>
      <hr />
      <h2>[제작중] GIECL</h2>
      <p><a href="https://gaetaeng.github.io/giec-homepage/" rel="nofollow">GIECL 이동</a></p>
      <hr />
      <h2>[제작중] [회사] (포트폴리오)</h2>
      ...
      <ul>
        ...
        <li><a href="https://flying-settee-718.notion.site/13a48f98630f451ba8964ca7717740a5?pvs=4" rel="nofollow">자세한 내용 보기</a></li>
      </ul>
    </div>
  );
}
